...
### [Section 1: IaC with Terraform](#section-1) (3 topics)
### [Section 2: Fundamentals](#section-2) (4 topics)
### [Section 3: Core Workflow](#section-3) (7 topics)
### [Section 4: Configuration](#section-4) (8 topics)
### [Section 5: Modules](#section-5) (4 topics)
### [Section 6: State Management](#section-6) (4 topics)
### [Section 7: Maintenance](#section-7) (3 topics)
### [Section 8: HCP Terraform](#section-8) (4 topics)

---

# Section 1: IaC with Terraform {#section-1}

## 1a: What is Infrastructure as Code? {#1a}
...
## 1c: Multi-cloud and Hybrid Cloud {#1c}
...
## 2a: Providers - Installation and Versioning {#2a}
...
## 2c: Using Multiple Providers {#2c}
...
## 4a: Resources vs Data Sources {#4a}
...
## 4e: Expressions and Functions {#4e}
...
## 5b: Variable Scope in Modules {#5b}
...
# Section 6: State Management {#section-6}
...
## 6d: Drift and State Management {#6d}
...
# Section 7: Maintaining Infrastructure {#section-7}

## 7a: Importing Resources {#7a}
